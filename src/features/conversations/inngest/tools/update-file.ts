...
export const createUpdateFileTool = ({
  ...
  return createTool({
    ...
    handler: async (params, { step: toolStep }) => {
      ...
      try {
        console.log("updateFile tool called:", { fileId, contentLength: content.length });
        return await toolStep?.run("update-file", async () => {
          console.log("Running updateFile mutation for:", file.name);
          ...
          console.log("File updated successfully:", file.name);
